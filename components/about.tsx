          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {missionCards.map((card, index) => {
              return (
                  <div
                      key={index}
                      className="bg-white rounded-xl transition-all duration-300 transform hover:-translate-y-2 py-8 px-6 border border-gray-200"
                      style={{
                        boxShadow: `0 10px 12px rgba(50, 140, 152, 0.15), 0 4px 4px rgba(50, 140, 152, 0.1)`,
                      }}
                      onMouseEnter={(e) => {
                  ...
                  >
                    <div className="flex flex-col items-center text-center h-full">
                      <div className="w-full aspect-square rounded-md overflow-clip flex items-center justify-center mb-6" style={{backgroundColor: 'rgba(50, 140, 152, 0.1)'}}>
                        <Image 
                        className="w-full"
                        width="256"
                        height="256"
