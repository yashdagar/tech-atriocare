        ...
        <div className="grid md:grid-cols-4 gap-8">
            ...
            <ul className="space-y-2">
              {
                products.map((product) => (
                  <li key={product.name}>
                <Link href={product.link} className="hover:text-primary transition-colors group flex" aria-label={product.name}>
                  {product.name}
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="https://www.instagram.com/tech.atriocare/" aria-label="Instagram" className="hover:text-primary transition-colors">
                <Instagram className="h-6 w-6" />
              </Link>
              <Link href="https://www.linkedin.com/company/tech-atriocare/" aria-label="Linkedin" className="hover:text-primary transition-colors">
